...
Kyselyt ovat kuitenkin hyödyttömiä opiskelijamäärien ollessa yli sata jokaista kurssiohjaajaa kohden: apua tarvitsevat löydetään liian myöhään. Tukea tarvitaan mahdollisimman varhaisessa vaiheessa jotta arvosanoihin voidaan vaikuttaa merkittävällä tavalla\cite{bergin2015using}. 

Ongelmaa on lähdetty ratkaisemaan automatisoimalla tunnistamisprosessia. % Ja tästä etiäppäin

% poista kun oleelliset sanottu tästä
Itse keskityn artikkeleihin jotka keskittyvät vaikeuksissa olevien opiskelijoiden tunnistamiseen ensimmäisillä ohjelmointikursseilla. Menetelmiin jotka tapahtuvat automaattisesti ja mahdollisimman varhaisessa vaiheessa. Tarkastelemani artikkelit keskittyivät ennustamaan tehtävä-, lopputentti- ja kurssiarvosanoja. 
