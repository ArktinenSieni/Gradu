...
Kaava antaa todennäköisyyden sille että havainto $x$ kuuluu luokkan $k$. Merkintään $Pr(Y = k | X = x)$ jatkossa viittaan merkinnällä $p_k(X)$. % Tän voi poistaa jos ei käytetä enempää
